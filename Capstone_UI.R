...
shinyUI(dashboardPage(
  dashboardHeader(title = "MARKET MAKING and STAT ARB",titleWidth = 450),
  dashboardSidebar(
    uiOutput("fname"),
    sidebarMenu(
      menuItem("Russell 3000", tabName = "russell3000"),
      menuItem("S & P 500", tabName = "snp500"),
      menuItem("Correlation Matrix", tabName = "cormat"),
      menuItem("FANGAM", tabName = "bigall"),
      menuItem("Pairs", tabName = "big2"),
      menuItem("Conclusion", tabName = "customtext")
    )
  ),
  dashboardBody(
    tabItems(
